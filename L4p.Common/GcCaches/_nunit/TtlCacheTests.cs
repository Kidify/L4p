...
namespace L4p.Common.GcCaches._nunit
{
    [TestFixture]
    class When_items_are_added
    {
        ...
        private static MyInstance[] shoot_dead_bodies(IGcCache<MyFacet, MyInstance> cache)
        {
            GC.Collect();
        ...
        {
            var cache = GcCache<MyFacet, MyInstance>.New();
